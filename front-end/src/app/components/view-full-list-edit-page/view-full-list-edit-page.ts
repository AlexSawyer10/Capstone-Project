...
@Component({
  selector: 'app-view-full-list-edit-page',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './view-full-list-edit-page.html',
  styleUrl: './view-full-list-edit-page.css',
})
export class ViewFullListEditPage {
  ...
  constructor(private router: Router, private route: ActivatedRoute,
              private listService: ListService, private commentService: CommentService,
  ...
  transferToEditList(): void {
    this.router.navigate(['/edit-list-page']);
  }
